...
const MOCK_USERNAME = 'myuser'
const MOCK_PASSWORD = 'mypassword'
const MOCK_APP_INITIAL_STATE = {
	username: null,
	password: null,
	authorized: false
}
...
describe('Redux - Action Reducers:', () => {
	describe('ActionCreator', () => {
		...
		it('should return an action_creator that just contains the action type (_type) if a null/falsy, non-function value is passed instead of the action creator function', done => {
	...
	describe('ReduxActionize:', () => {
		...
		var login_action_reducer = application_state.reducers.login,
		...
		describe('Chained registration', done => {
			...
			var login_action_reducer = application_state.reducers.login,
				login_action_creator = application_state.actions.login,
				logout_action_reducer = application_state.reducers.logout,
				...
				it('should add action creators', done => {
					...
					expect( logout_action_creator() ).to.deep.equal({ _type: 'logout' })
